...
class User(object):
    ...
    def is_login_valid(email, password):
        """
        This method verifies that an email/password combo (as set by the site forms) is valid or not.
        Checks that an email exists, and that the password associated with that email is correct.
    ...
    def register_user(email, password):
        ...
        User(email, Utils.hash_password(password), _id=None).save_to_db()
